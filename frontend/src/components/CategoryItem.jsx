...
const CategoryItem = ({ category }) => {
    ...
    //   <a
    //     href={category.href}
    //     className="flex flex-col items-center bg-gray-100 shadow-md rounded-lg overflow-hidden w-64 h-80 border-2 border-transparent hover:border-blue-600 transition-all duration-300"
    //   >
    //     <img
    //       src={category.image}
    //       alt={category.name}
